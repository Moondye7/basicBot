...
(function () {
    ...
    var loadChat = function (cb) {
        ...
        $.get("https://rawgit.com/Moondye7/basicBot/master/lang/langIndex.json", function (json) {
            ...
            helpCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        var link = "(http://support.plug.dj/hc/en-us/categories/200151458-Frequently-Asked-Questions)";
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        if (typeof basicBot.settings.website === "string")
                            API.sendChat(subChat(basicBot.chat.twitch, {link: basicBot.settings.twitch}));
                    }
                }
            },
            ...
            cancerCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat(basicBot.chat.cancer)
                    }
                }
            },
              ...
              BaconCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat(basicBot.chat.bacon)
                    }
                }
            },
            ...
            nextstreamCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat(basicBot.chat.nextstream)
                    }
                }
            },
            ...
            nazimodCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat(basicBot.chat.nazimod)
                    }
                }
            },
            ...
            simplexCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat(basicBot.chat.simplex)
                    }
                }
            },
            ...
            riotCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat(basicBot.chat.riot)
                    }
                }
            },
              ...
              changelogCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat(basicBot.chat.changelog)
                    }
                }
            },
